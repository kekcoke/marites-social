...
class EventCreate(EventBase):
    """Schema for creating an event - ID is generated by DB"""
...
class EventResponse(EventBase):
    """Schema for event responses - includes all DB fields"""
    id: UUID # Moved from Base to Response
    creator_user_id: Optional[UUID] = None
    event_chat_ids: Optional[List[UUID]] = None
...
class EventWithDetails(EventResponse):
    """Event with related details for complex UI views"""
